        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 card-title">وصل التسديد اقساط</h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{route('installmentPay.store')}}" autocomplete="on" method="post" enctype="multipart/form-data" >                                
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">المبلغ الشهري المستلم من الزبون (بالدينار)</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="months_number" name="months_number" class="custom-select @error('months_number') is-invalid state-invalid @enderror">
