    ...
    <div class="page-header">
        <div class="mr-auto">
            <div class="input-group">
                <a class="btn btn-primary ml-5 mt-4 mt-sm-0" href="{{ url('suppliers/create') }}"> إضافة مورد جديد <i class="fe fe-plus ml-1 mt-1"></i></a>
            </div>
        </div>
    </div>
    <!-- End page-header -->
                            ...
                            @foreach($suppliers as $key=>$supplier)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='{{url("suppliers/$supplier->id/edit")}}' class="btn btn-danger" data-toggle="tooltip" data-placement="top" data-original-title="حذف"><i class="si si-trash text-light"></i></a>
