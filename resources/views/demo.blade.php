    ...
    <div class="page-header">
        ...
        <div class="mr-auto">
            <div class="input-group">
                <a  class="btn btn-primary text-white ml-2"  id="daterange-btn">
                    <span>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-5 mb-lg-0">
                                <h4 class="mb-4 d-block">
                                    ...
                                    <span class="float-left font-weight-bold">50%</span>
                                </h4>
                                <div class="progress progress-md h-1">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-5 mb-lg-0">
                                <h4 class="mb-4 d-block">
                                    ...
                                    <span class="float-left font-weight-bold">25%</span>
                                </h4>
                                <div class="progress progress-md h-1">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-0 mb-md-0">
                                <h4 class="mb-4 d-block">
                                    ...
                                    <span class="float-left font-weight-bold">15%</span>
                                </h4>
                                <div class="progress progress-md h-1">
                        ...
                        <ul class="contacts mb-0">
                            <li class="active">
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="float-right  text-left  mr-auto mt-auto mb-auto"><small>01-02-2019</small></div>
                                </div>
                            </li>
                            <li>
                                <div class="d-flex bd-highlight">
                            ...
                            <li>
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="float-right  text-left  mr-auto mt-auto mb-auto"><small>02-02-2019</small></div>
                                </div>
                            </li>
                            <li>
                                <div class="d-flex bd-highlight">
                            ...
                            <li>
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="float-right  text-left  mr-auto mt-auto mb-auto"><small>03-02-2019</small></div>
                                </div>
                            </li>
                            <li>
                                <div class="d-flex bd-highlight">
