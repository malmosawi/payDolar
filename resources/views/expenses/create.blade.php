        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('expenses.store')}}" autocomplete="on" method="post" enctype="multipart/form-data" >                                
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('expenses_name') is-invalid state-invalid @enderror" name="expenses_name" id="expenses_name" value="{{ old('expenses_name') }}" placeholder="">
                                </div>
                            </div>
